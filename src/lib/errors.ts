...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  module_not_installed: "El módulo appex_backup no está instalado en esta base de datos.",
  database_not_listed: "El gestor de BD no lista esta base de datos (revisa dbfilter y el dominio).",
  module_api_incompatible: "La versión del módulo appex_backup no es compatible con esta aplicación.",
  ...
  no_transport_available:
    "No hay transporte disponible: instala el módulo appex_backup o habilita list_db con contraseña maestra.",
  api_key_required: "El módulo appex_backup requiere una API key (no una contraseña).",
