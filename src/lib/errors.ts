...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  server_backup_error: "El servidor informó un error al generar el respaldo.",
  prepare_timeout: "El servidor no terminó de preparar el respaldo a tiempo.",
  invalid_backup: "El archivo descargado no es un respaldo válido.",
  ...
  backup_in_progress: "Ya hay un respaldo en curso para esta instancia.",
  job_not_found: "El respaldo ya no está en curso.",
  ...
  file_missing: "El archivo del respaldo ya no existe en el disco.",
  browser_open_failed: "No se pudo abrir el navegador para autorizar Google Drive.",
  history_db: "No se pudo leer o guardar el historial de respaldos.",
  interrupted: "La aplicación se cerró mientras se hacía el respaldo.",
