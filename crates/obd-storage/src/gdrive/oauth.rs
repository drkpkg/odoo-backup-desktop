...
const PAGE_SUCCESS: &str = "<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><title>Odoo Backup Desktop</title></head>\
<body style=\"font-family:sans-serif;padding:3rem\"><h1>Odoo Backup Desktop: autorización completada, puedes cerrar esta ventana.</h1></body></html>";

const PAGE_DENIED: &str = "<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><title>Odoo Backup Desktop</title></head>\
<body style=\"font-family:sans-serif;padding:3rem\"><h1>Odoo Backup Desktop: la autorización fue cancelada. Puedes cerrar esta ventana.</h1></body></html>";

const PAGE_ERROR: &str = "<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><title>Odoo Backup Desktop</title></head>\
<body style=\"font-family:sans-serif;padding:3rem\"><h1>Odoo Backup Desktop: no se pudo completar la autorización.</h1><p>Vuelve a la aplicación para ver el detalle.</p></body></html>";

const PAGE_INVALID: &str = "<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><title>Odoo Backup Desktop</title></head>\
<body style=\"font-family:sans-serif;padding:3rem\"><h1>Odoo Backup Desktop: solicitud de autorización no válida.</h1></body></html>";

const PAGE_NOT_FOUND: &str = "<!doctype html><html lang=\"es\"><head><meta charset=\"utf-8\"><title>Odoo Backup Desktop</title></head><body>No encontrado</body></html>";
