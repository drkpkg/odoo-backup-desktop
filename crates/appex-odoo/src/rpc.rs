...
mod tests {
    ...
    fn missing_model_messages() {
        assert!(is_missing_model_message("Object appex.backup.api doesn't exist", "appex.backup.api"));
        assert!(is_missing_model_message("the model 'appex.backup.api' does not exist", "appex.backup.api"));
        assert!(!is_missing_model_message("Object res.partner doesn't exist", "appex.backup.api"));
        assert!(!is_missing_model_message("The method 'appex.backup.api.nope' does not exist", "appex.backup.api"));
    }
}
