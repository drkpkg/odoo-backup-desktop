//! Odoo 15.0–19.0 client used by Appex Backup.
//!
...
//! - [`transport`]: backup transports ([`DbManagerTransport`], [`AppexModuleTransport`]).
...
pub use transport::{
    AppexModuleTransport, BackupPhase, BackupRequest, BackupTransport, DbManagerTransport, DownloadedBackup,
    ProgressFn, TransportKind,
};
